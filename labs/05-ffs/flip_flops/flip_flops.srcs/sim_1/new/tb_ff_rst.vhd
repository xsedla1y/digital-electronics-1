...
begin
    ...
    p_reset_gen : process
    begin
        s_rst <= '0'; wait for 38ns;
        s_rst <= '1'; wait for 42ns;
        s_rst <= '0'; wait for 26ns;
        s_rst <= '1'; wait for 48ns;
        s_rst <= '0'; wait for 35ns;
    ...
    begin
        ...
        s_data <='0'; wait for 32 ns;
        s_data <='1'; wait for 18 ns;
        s_data <='0'; wait for 24 ns;
        s_data <='1'; wait for 28 ns;
        s_data <='0'; wait for 19 ns;
        s_data <='1'; wait for 37 ns;
        s_data <='0';
